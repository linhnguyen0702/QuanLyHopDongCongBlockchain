...
export const contractAPI = {
  ...
  activateContract: (id, comment) =>
    api.post(`/contracts/${id}/activate`, { comment }),
...
export const contractorAPI = {
  ...
  createContractor: (contractorData) =>
    api.post("/contractors", contractorData),
  updateContractor: (id, contractorData) =>
    api.put(`/contractors/${id}`, contractorData),
...
export const reportAPI = {
  ...
  getContractTrends: (params) =>
    api.get("/reports/contracts/trends", { params }),
  getExpiringContracts: (params) =>
    api.get("/reports/contracts/expiring", { params }),
